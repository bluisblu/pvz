...
void CursorObject::Draw(Sexy::Graphics *g)
{
    ...
    if (CVar1 != CURSOR_TYPE_MONEY_SIGN)
    {
        ...
        {
            pPVar5 = mBoard->mPlants->DataArrayGet(mGlovePlantID);
        ...
        else
        {
            ...
            {
                /*if (((CVar1 == CURSOR_TYPE_PLANT_FROM_BANK) || (CVar1 ==
                CURSOR_TYPE_PLANT_FROM_USABLE_COIN)) || (CVar1 ==
                CURSOR_TYPE_PLANT_FROM_DUPLICATOR))
                {
                    local_8.mObject = (HitResult *)0xc1200000;
                    local_c = PlantDrawHeightOffset(mBoard, 0x0, mType, -1, -1);
                    local_c = local_c - 10.0;
                    bVar3 = Plant::IsFlying(mType);
                    if ((bVar3) || (mType == SEED_GRAVEBUSTER))
                    {
                    ...
                    Plant::DrawSeedType(g, mType, mImitaterType, VARIATION_NORMAL, local_8.mObject,
                                        local_c);
                    return;
                }*/
