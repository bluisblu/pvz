...
Reanimation::Reanimation()
{
    ...
    mColorOverride.mRed = Sexy::Color::White.mRed;
    mColorOverride.mGreen = Sexy::Color::White.mGreen;
    mColorOverride.mBlue = Sexy::Color::White.mBlue;
    mColorOverride.mAlpha = Sexy::Color::White.mAlpha;
    mExtraAdditiveColor.mRed = Sexy::Color::White.mRed;
    mExtraAdditiveColor.mGreen = Sexy::Color::White.mGreen;
    mExtraAdditiveColor.mBlue = Sexy::Color::White.mBlue;
    mExtraAdditiveColor.mAlpha = Sexy::Color::White.mAlpha;
    mEnableExtraAdditiveDraw = false;
    mExtraOverlayColor.mRed = Sexy::Color::White.mRed;
    mExtraOverlayColor.mGreen = Sexy::Color::White.mGreen;
    mLoopCount = 0;
    mExtraOverlayColor.mBlue = Sexy::Color::White.mBlue;
    mExtraOverlayColor.mAlpha = Sexy::Color::White.mAlpha;
    mIsAttachment = false;
    mRenderOrder = 0;
